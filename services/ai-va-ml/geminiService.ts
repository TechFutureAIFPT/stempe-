...
import type { Candidate, HardFilters, WeightCriteria, MainCriterion, SubCriterion, AnalysisRunData, ChatMessage } from '../../assets/types';
import { processFileToText } from '../xu-ly-file/ocrService';
import { MODEL_NAME } from '../../assets/constants';
import { analysisCacheService } from '../lich-su-va-cache/analysisCache';
