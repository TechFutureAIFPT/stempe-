...
import { analyzeCVs } from '../../../services/ai-va-ml/geminiService';
...
const CVUpload: React.FC<CVUploadProps> = memo((props) => {
  ...
  return (
    <section id="module-upload" className="module-pane active relative w-full h-[calc(100vh)] min-h-[400px] flex flex-col bg-[#0B1120]">
      ...
      <div className="flex-none bg-[#0B1120] px-6 py-2 border-b border-slate-800/40">
          <div className="flex items-center gap-3 text-xs">
             ...
             <div className="px-3 py-1.5 rounded-full border border-slate-700 bg-slate-800 text-slate-300">
               Đã chọn: <span className="text-white font-bold">{cvFiles.length}</span> / {MAX_CV_PER_BATCH}
             </div>
          </div>
      </div>
            ...
            <div className="lg:col-span-5 space-y-4">
              ...
              <div className="relative group">
                 ...
                 <div className="relative bg-slate-900 rounded-xl p-6 border border-slate-800 hover:border-slate-700 transition-colors text-center">
                    ...
                    <h4 className="text-base font-medium text-white mb-0.5">Kéo thả hoặc chọn file</h4>
                    <p className="text-[10px] text-slate-500 mb-3">PDF, DOCX, PNG, JPG (Max {MAX_CV_PER_BATCH})</p>
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-bold text-base shadow-lg transition-all flex items-center justify-center gap-3 ${
