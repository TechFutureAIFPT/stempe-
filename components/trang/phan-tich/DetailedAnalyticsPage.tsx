...
const DetailedAnalyticsPage: React.FC<DetailedAnalyticsPageProps> = ({ candidates, jobPosition, onReset }) => {
  ...
  if (!analyticsData) {
    return (
      <section id="module-dashboard" className="module-pane active relative w-full h-[calc(100vh)] min-h-[600px] flex flex-col bg-[#0B1120]">
        ...
        <div className="flex-none h-16 border-b border-slate-800/60 bg-[#0B1120] z-20 px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <i className="fa-solid fa-chart-pie text-blue-400 text-xl drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]"></i>
            <div>
              <h3 className="text-[15px] font-bold text-white tracking-wide leading-tight">Thống Kê Chi Tiết</h3>
              <p className="text-[9px] text-slate-500 tracking-[0.2em] font-medium uppercase mt-0.5">DASHBOARD</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center p-6 text-center z-10">
          <div>
            <div className="relative inline-block mb-6">
              <i className="fa-solid fa-chart-pie text-5xl md:text-6xl text-slate-600 float-animation"></i>
            ...
            <p className="text-slate-400 text-lg max-w-md mx-auto leading-relaxed">
              Vui lòng thực hiện phân tích CV trước để xem được báo cáo thống kê này.
            </p>
          </div>
        </div>
      </section>
  ...
  return (
    <section id="module-dashboard" className="module-pane active relative w-full h-[calc(100vh)] min-h-[600px] flex flex-col bg-[#0B1120]">
      ...
      {/* Main Content Area */}
      <div className="flex flex-1 overflow-hidden relative z-10 w-full h-[calc(100vh-4rem)]">
        <div className="w-full h-full p-4 lg:p-6 lg:px-8 overflow-y-auto custom-scrollbar">
          <div className="max-w-7xl mx-auto space-y-8 pb-10">
            {/* Header / Stats Grid Wrapper */}
            <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/20 shrink-0">
                ...
                <div>
                  ...
                  <p className="text-slate-400 mt-1 flex items-center gap-2 text-sm">
                    Phân tích sâu cho: <span className="font-semibold text-slate-200 bg-slate-700/50 px-2 py-0.5 rounded border border-slate-600/50 truncate max-w-[200px] md:max-w-md">{jobPosition}</span>
                  </p>
                </div>
              </div>
        ...
        <div className="mt-10 text-center">
          <button 
            ...
            className={`px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white rounded-2xl font-bold shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-all duration-300 transform hover:-translate-y-1 flex items-center gap-3 mx-auto`}
          >
            <i className="fa-solid fa-check-circle text-xl"></i>
            Chuyển đến Gợi ý ứng viên
          </button>
        </div>
      </div>
    </div>
